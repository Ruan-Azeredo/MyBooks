...
export default function SidebarComponent() {
    ...
    return (
        <div className={`w-full flex col-start-1 col-end-2 fixed left-8 top-[310px]`}>
            ...
            `}>
                <button className="w-16 hover:text-yellow-400" onClick={openModal} value='Autor'>+ Autor</button>
                <button className="w-16 hover:text-yellow-400" onClick={openModal} value='Livro'>+ Livro</button>
